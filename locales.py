...
TEXTS: Final[dict[str, dict[str, str]]] = {
    "ru": {
        ...
        "super_admin_panel_hint": "Нажмите «Создать пост» для прямой публикации. Заявки обычных пользователей приходят в этот чат с кнопками «Выложить» и «Редактировать».",
        ...
        "send_video_only": "На этом шаге принимаются обычные видео и видеофайлы MP4, MOV, MKV, AVI или WEBM. GIF-анимации, видеосообщения и другие файлы не подходят. После загрузки нажмите «Медиа загружены».",
        "media_outside_post_creation": "Нет активного создания поста. Нажмите «Создать пост», дождитесь сообщения «Загрузите видео», затем отправьте обычное видео или видеофайл MP4, MOV, MKV, AVI либо WEBM.",
        "media_not_expected": "Видео сейчас не ожидается. Завершите текущий шаг сценария или отмените его и начните создание поста заново.",
        "media_expected": "На этом шаге нужно отправить медиафайл. Пожалуйста, загрузите видео или нажмите кнопку «Медиа загружены».",
    ...
    "en": {
        ...
        "super_admin_panel_hint": "Tap “Create post” for a direct publication. Regular users' requests arrive in this chat with “Publish” and “Edit” buttons.",
        ...
        "send_video_only": "Regular videos and MP4, MOV, MKV, AVI, or WEBM video files are accepted here. GIF animations, video notes, and other files are not supported. Tap “Media uploaded” after uploading them.",
        "media_outside_post_creation": "There is no active post creation. Tap “Create post”, wait for the video-upload prompt, then send a regular video or an MP4, MOV, MKV, AVI, or WEBM video file.",
        "media_not_expected": "A video is not expected right now. Complete the current step or cancel it and start post creation again.",
        "media_expected": "Send a media file at this step. Please upload a video or tap “Media uploaded”.",
    ...
    "ar": {
        ...
        "super_admin_panel_hint": "اضغط «إنشاء منشور» للنشر المباشر. تصل طلبات المستخدمين العاديين إلى هذه المحادثة مع زري «نشر» و«تعديل».",
        ...
        "send_video_only": "تُقبل مقاطع الفيديو العادية وملفات الفيديو بصيغ MP4 وMOV وMKV وAVI وWEBM في هذه الخطوة. لا تُقبل صور GIF المتحركة أو رسائل الفيديو أو الملفات الأخرى. اضغط «تم تحميل الوسائط» بعد التحميل.",
        "media_outside_post_creation": "لا توجد عملية إنشاء منشور نشطة. اضغط «إنشاء منشور»، وانتظر رسالة تحميل الفيديو، ثم أرسل فيديو عاديًا أو ملف فيديو بصيغة MP4 أو MOV أو MKV أو AVI أو WEBM.",
        "media_not_expected": "الفيديو غير مطلوب الآن. أكمل الخطوة الحالية أو ألغِها وابدأ إنشاء المنشور من جديد.",
        "media_expected": "أرسل ملف وسائط في هذه الخطوة. يرجى تحميل فيديو أو الضغط على «تم تحميل الوسائط».",
        "media_too_large": "الملف كبير جدًا. يسمح Telegram بملفات حتى {max_size_mb} ميغابايت فقط. يرجى ضغط الفيديو قبل إرساله.",
        ...
        "invalid_price": "يرجى إدخال رقم فقط (مثل 15000) من دون أحرف أو مسافات.",
        ...
        "post_save_failed": "تعذر حفظ المنشور. تم تسجيل الخطأ في السجل. حاول مرة أخرى بعد دقيقة أو تواصل مع المسؤول.",
