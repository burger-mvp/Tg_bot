...
RU_TEXTS = {
    ...
    "ban_author": "❌ Заблокировать автора",
    "author_banned": "Автор заблокирован, пост отклонен.",
    "author_banned_notification": "Ваш аккаунт заблокирован администратором.",
    "banned_user_message": "Ваш аккаунт заблокирован администратором.",
    "ban_usage": "Используйте: /ban [user_id]",
    "unban_usage": "Используйте: /unban [user_id]",
    "ban_success": "Пользователь {user_id} заблокирован.",
    "unban_success": "Пользователь {user_id} разблокирован.",
    "ban_user_not_found": "Пользователь {user_id} не найден. Он должен сначала пройти /start.",
    ...
    "delete_web_listing": "🗑 Удалить объявление с сайта",
    "edit_published_post": "✏️ Редактировать опубликованный пост",
    "edit_published_post_id_prompt": "Пришлите UUID опубликованного поста. Его можно взять из недельного отчета или из внутренних данных очереди.",
    "edit_published_post_invalid_id": "Не вижу корректный UUID поста. Пришлите ID вида 123e4567-e89b-12d3-a456-426614174000.",
    "edit_published_post_not_found": "Опубликованный пост с таким UUID не найден.",
    "edit_published_post_text_prompt": "Пришлите новый текст описания. Цена, фото/видео и магазин останутся прежними.",
    "edit_published_post_saved": "✅ Текст опубликованного поста обновлен в базе. Telegram: {telegram_status}. Сайт: {site_status}",
    "edit_published_post_no_message": "старый пост без сохраненного ID сообщения, автоматически изменить его в канале нельзя",
    "edit_published_post_telegram_ok": "обновлен",
    "edit_published_post_telegram_failed": "не удалось обновить ({error})",
    "edit_published_post_site_ok": "обновлен, если карточка уже есть",
    "edit_published_post_site_failed": "не удалось обновить ({error})",
    "weekly_publication_report": "📈 Недельная отчетность",
    "weekly_report_empty": "За последние 7 дней опубликованных постов не найдено.",
    "weekly_report_header": "📈 Отчет по публикациям за последние 7 дней\nВсего постов: {total}\n\n",
    "weekly_report_item": "{index}. {shop_name} — {count} пост(ов)\nID продавца: {telegram_id}\n{user_label}\nUUID постов: {post_ids}",
    "delete_web_listing_prompt": "Пришлите ссылку на объявление сайта, которое нужно удалить.",
    "delete_web_listing_invalid": "Не вижу ID объявления. Пришлите ссылку вида https://km-logistics.ru/listing/....",
    "delete_web_listing_success": "✅ Объявление скрыто с сайта.",
    "delete_web_listing_failed": "Не удалось удалить объявление: {error}",
    "enter_telegram_id_for_ban": "Введите Telegram ID пользователя, которого нужно заблокировать:",
    "enter_telegram_id_for_unban": "Введите Telegram ID пользователя, которого нужно разблокировать:",
...
EN_TEXTS = {
    ...
    "ban_author": "❌ Block author",
    "author_banned": "Author blocked, post rejected.",
    "author_banned_notification": "Your account has been blocked by an administrator.",
    "banned_user_message": "Your account has been blocked by an administrator.",
    "ban_usage": "Use: /ban [user_id]",
    "unban_usage": "Use: /unban [user_id]",
    "ban_success": "User {user_id} has been blocked.",
    "unban_success": "User {user_id} has been unblocked.",
    "ban_user_not_found": "User {user_id} was not found. They must complete /start first.",
    ...
    "ban_user": "🚫 Block user",
    "unban_user": "✅ Unblock user",
    "delete_web_listing": "🗑 Delete site listing",
    "edit_published_post": "✏️ Edit published post",
    "edit_published_post_id_prompt": "Send the UUID of the published post. You can take it from the weekly report or internal queue data.",
    "edit_published_post_invalid_id": "I cannot see a valid post UUID. Send an ID like 123e4567-e89b-12d3-a456-426614174000.",
    "edit_published_post_not_found": "Published post with this UUID was not found.",
    "edit_published_post_text_prompt": "Send the new description text. Price, photos/videos and shop will stay unchanged.",
    "edit_published_post_saved": "✅ Published post text was updated in the database. Telegram: {telegram_status}. Site: {site_status}",
    "edit_published_post_no_message": "old post has no saved message ID, so it cannot be changed in the channel automatically",
    "edit_published_post_telegram_ok": "updated",
    "edit_published_post_telegram_failed": "failed to update ({error})",
    "edit_published_post_site_ok": "updated if the listing exists",
    "edit_published_post_site_failed": "failed to update ({error})",
    "weekly_publication_report": "📈 Weekly report",
    "weekly_report_empty": "No published posts found for the last 7 days.",
    "weekly_report_header": "📈 Publication report for the last 7 days\nTotal posts: {total}\n\n",
    "weekly_report_item": "{index}. {shop_name} — {count} post(s)\nSeller ID: {telegram_id}\n{user_label}\nPost UUIDs: {post_ids}",
    "delete_web_listing_prompt": "Send the site listing link you want to delete.",
    "delete_web_listing_invalid": "I cannot find the listing ID. Send a link like https://km-logistics.ru/listing/....",
    "delete_web_listing_success": "✅ Listing hidden from the site.",
    "delete_web_listing_failed": "Could not delete listing: {error}",
    "enter_telegram_id_for_ban": "Enter the Telegram ID of the user to block:",
    "enter_telegram_id_for_unban": "Enter the Telegram ID of the user to unblock:",
