...
RU_TEXTS = {
    ...
    "duplicate_list_header": "Ближайшие дубли к публикации:",
    "duplicate_list_item": "{index}. {shop_name} — {duplicate_due_at}\n{description}",
...
EN_TEXTS = {
    ...
    "queue_list_item": "{index}. {shop_name} — {scheduled_at}\n{description}",
    "duplicate_list_header": "Next duplicates scheduled for publication:",
    "duplicate_list_item": "{index}. {shop_name} — {duplicate_due_at}\n{description}",
